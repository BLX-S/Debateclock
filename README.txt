A Pen created at CodePen.io. You can find this one at https://codepen.io/anon/pen/pdBoXR.
...
Tap to stop/reset/start.
When stopped, slide to set the time (it's a little hard to get it to an exact value).
